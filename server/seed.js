module.exports = (User, Goal, Task) => {
  ...
  .then(_goals => {
    return Promise.all([
      ...
      Task.create({ title: 'T4', description: 'Want to go to Burundi', goalId: 3 }),
      Task.create({ title: 'T5', description: 'Want to go to Burundi', goalId: 3 }),
      Task.create({ title: 'T6', description: 'Want to go to Burundi', goalId: 3 })
    ])
  })
}
