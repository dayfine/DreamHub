...
module.exports = (User, Goal, Task, Category) => {
  ...
  .then(() => {
    return Promise.all([
      Task.create({ title: 'Research attractions in Peru', description: 'Look for fun places to visit in Peru', goalId: 1 }),
      Task.create({ title: 'Research Europe Destinations', description: 'Maybe London, maybe Paris, maybe Rome', goalId: 2 }),
      Task.create({ title: 'Research Flight Prices', description: 'Find the cheapest flights', goalId: 2 }),
      Task.create({ title: 'Customize the code in TaskMapper', description: 'In line 46 edit the code in TaskMapper', goalId: 3 }),
      Task.create({ title: 'Enroll in Spanish Course', description: 'Find a good Spanish class', goalId: 4, status: 'Completed' }),
      ...
      Task.create({ title: 'Buy Steak from market', description: 'Go to the market and buy steak', goalId: 7 }),
      Task.create({ title: 'Prep the steak for cooking', description: 'Add seasoning to steak', goalId: 7 }),
      Task.create({ title: 'Cook steak', description: 'Put steak on grill and heat until temperature', goalId: 7, status: 'Completed' }),
